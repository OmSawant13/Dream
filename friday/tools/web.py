...
def register(mcp):
    ...
    async def open_url(url: str) -> str:
        ...
        Use this when the user asks to 'open', 'look up', or 'go to' a specific website.
        """
        import webbrowser
        ...
        try:
            webbrowser.open(url)
            return f"Opening {url} on your primary display now, boss."
        except Exception as e:
            return f"I encountered an error trying to access the browser: {str(e)}"